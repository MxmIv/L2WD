        ...
        <div>
            ...
            <section className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: `url('/images/landing_page.jpg')` }}>
                ...
                <div className="relative z-10 flex flex-col justify-center items-center h-full">
                    <h1 className="roboto-medium text-4xl sm:text-6xl text-white text-center">
            ...
            <div className="container mx-auto px-4 py-10">
                <h2 className="roboto-bold text-3xl mb-6">What we offer</h2>
                <p className="roboto-regular text-lg mb-4">
