...
export default function WeddingDanceLessons() {
    return (
        <div className="container mx-auto px-4 py-20">
            ...
            <img src="/images/wedding-dance.jpg" alt="Wedding Dance" className="rounded-lg mb-6" />
            <p className="mb-4">
                Whether youre a complete beginner or looking to perfect your moves, our experienced instructors will guide you every step of the way.
            </p>
